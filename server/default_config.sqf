...
A3W_disableGlobalVoice = 0;        // Auto-switch channel to Direct communication whenever broadcasting voice on global, unless being admin (0 = no, 1 = yes)
...
A3W_bleedingTime = 600;             // Time in seconds for which to allow revive after a critical injury (minimum 10 seconds)
...
A3W_hcPrefix = "HC";           // Prefix of the headless client unit names in mission.sqm
