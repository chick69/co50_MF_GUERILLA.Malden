...
//-------------------- SPAWN BRIEFING
	...
	sideMarkerText = "Libérer et ramener le journaliste à la base"; publicVariable "sideMarkerText";
	"sideMarker" setMarkerText "Mission secondaire: Libérer et ramener le journaliste à la base"; publicVariable "sideMarker";
	publicVariable "sideObj";
	_briefing = "<t align='center'><t size='2.2'>Nouvelle Mission</t><br/><t size='1.5' color='#00B2EE'>Libérer le journaliste</t><br/>____________________<br/>Un journaliste d'une gande chaîne télévisée a été prise en otage.<br/><br/> Les rebels le retiennenent et préparent son éxecution. Retrouvez le et ramenez-le à la base principale.</t>";
	GlobalHint = _briefing; hint parseText GlobalHint; publicVariable "GlobalHint";
	showNotification = ["Nouvelle Mission", "Libérer le journaliste"]; publicVariable "showNotification";
	_null = [west, "journaliste", ["Un journaliste d'une gande chaîne télévisée a été prise en otage.<br/><br/> Les rebels le retiennenent et préparent son éxecution. Retrouvez le et ramenez-le à la base principale.", "Libérer le journaliste", "Libérer le journaliste"], getMarkerPos "SideMarker", true] spawn BIS_fnc_taskCreate;  
