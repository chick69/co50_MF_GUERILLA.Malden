...
_c4Message = ["Les charges sont posées, 15 secondes avant explosion!","Dégagez la zone! Les charges vont exploser dans 15 secondes!","Le zone est plastiquée! 15 secondes avant mise à feu!"] call BIS_fnc_selectRandom;
...
//-------------------- SPAWN OBJECTIVE
	...
	building1 = "Headgear_H_HelmetSpecB" createVehicle _flatPos4;
	building2 = "Item_B_UavTerminal" createVehicle _flatPos5;
	building3 = "B_UAV_01_F" createVehicle _flatPos6;
...
//-------------------- SPAWN BRIEFING
	...
	sideMarkerText = "Trouver le drône"; publicVariable "sideMarkerText";
	"sideMarker_1" setMarkerText "Trouver le drône"; publicVariable "sideMarker_1";
	publicVariable "sideObj2";
	_briefing = "<t align='center'><t size='2.2'>Nouvelle Mission</t><br/><t size='1.5' color='#00B2EE'>Trouver le drône</t><br/>____________________<br/>Des civils ont remarqué le passage d'un drône dans cette zone<br/><br/>trouvez-le et plastiquez la position...</t>";
	GlobalHint = _briefing; hint parseText GlobalHint; publicVariable "GlobalHint";
	showNotification = ["Nouvelle Mission", "Trouver le drône"]; publicVariable "showNotification";
	sideMarkerText = "Trouver le drône"; publicVariable "sideMarkerText";
	_null = [west, "drone", ["Des civils ont remarqué le passage d'un drône dans cette zone<br/><br/>trouvez-le et plastiquez la position...", "Trouver le drône", "Trouver le drône"], getMarkerPos "sideMarker_1", true] spawn BIS_fnc_taskCreate; 	
...
while { sideMissionUp2 } do {
	...
	if (!alive sideObj2) exitWith {
		...
		_null = ["drone", "FAILED"] spawn BIS_fnc_taskSetState;
		sleep 5;
		["drone"] call BIS_fnc_deleteTask; 
	...
	if (SM_SUCCESS) exitWith {
		...
		{ _x setMarkerPos [-10000,-10000,-10000]; } forEach ["sideMarker_1", "sideCircle_1"]; publicVariable "sideMarker_1";
		_null = ["drone", "SUCCEEDED"] spawn BIS_fnc_taskSetState;
		sleep 5;
		["drone"] call BIS_fnc_deleteTask; 
		...
		sleep 120;
		{ deleteVehicle _x } forEach [sideObj2,building4,building5,building6];
		deleteVehicle nearestObject [getPos sideObj2,"CamoNet_INDP_big_F"];
