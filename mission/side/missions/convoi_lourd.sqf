...
//-------------------- création fin de convoi
	...
	while {!_accepted2} do {
		...
		if ((_flatDestination distance (getMarkerPos "sideMarker_1")) > 3000) then {
			...
			_null = [west, "convoi", ["Un convoi doit transporter une cargaison de munitions.<br/>Nous ne connaissons ni son heure de départ ni son heure d'arrivée, mais nous savons d'où il partira et où il arrivera. Faites le job, tuez-les tous et récupérer le matériel en état de fonctionnement...", "Intercepter le convoi lourd", "Intercepter le convoi lourd"], getMarkerPos "SideMarker_2", true] spawn BIS_fnc_taskCreate;  
...
_veh2 = "O_APC_Wheeled_02_rcws_F" createVehicle getMarkerPos "sideMarker_1";
...
_veh3 = "I_APC_Wheeled_03_cannon_F" createVehicle getMarkerPos "sideMarker_1";
